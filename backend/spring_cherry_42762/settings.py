"""
Django settings for spring_cherry_42762 project.
...
ROOT_URLCONF = 'spring_cherry_42762.urls'
...
WSGI_APPLICATION = 'spring_cherry_42762.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "spring_cherry_42762 API",
    "DESCRIPTION": "API documentation for spring_cherry_42762 App",
    "VERSION": "v1",
}
